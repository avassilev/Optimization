...
\textbf{Note:} A point where all partial derivatives vanish is called a \emph{critical point} or a \emph{stationary point} of the function $ f $. This also applies to functions on $ \mathbb{R}^1 $.
\end{frame}
...
Example \ref{ex:saddle} illustrates the need for a counterpart of Fact \ref{fc:SCsR1} in the $ n $-dimensional case. 
\end{frame}
